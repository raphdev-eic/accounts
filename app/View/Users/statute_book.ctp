      ...
      <header class="header white-bg">
          ...
          <div class="top-nav">
              <ul class="nav pull-right top-menu">
                <span>Déjà inscrit ? Cliquez ici  </span><a href="<?php echo $this->Html->url(array('action'=>'login',urlencode('?service=Auth'))); ?>" class="btn btn-info">connexion</a>
              </ul>
          </div>
      </header>
      <!--header end-->
<?php echo $this->end(); ?>
        ...
        <div class="login-wrap">
            ...
            <?php echo $this->Form->button('Activez',array('class'=>'btn btn-lg btn-login btn-block')); ?>
        </div>
